...
const UserLogin = () => {
    ...
    return (
        <div className='h-screen overflow-hidden text-gray-100 bg-gradient-to-t from-zinc-800 to-gray-900'>
            <form onSubmit={handleSubmit} className="max-w-md mx-auto px-8 py-6 my-[15%] rounded-lg shadow-md border-[.5px] border-zinc-500">
                <h2 className="text-3xl text-center font-bold mb-6">Login  account</h2>
                <div className="mb-4">
                ...
                <div className='flex items-center text-center justify-center mt-2'>
                    <p className='text-xs' > Not have an account? <Link to={'/usersignUp'} className='text-xs text-[#1d4ed8]'>Sign Up</Link></p>
                </div>
